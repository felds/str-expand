...
test('expand multiple ranges', () => {
    expect(expand('http://example.com/[1..2]/[3..4].jpg'))
        .toEqual([
...
test('expand enum', () => {
    expect(expand('banana {bread,muffin,cake}'))
        .toEqual([
            'banana bread',
            'banana muffin',
            'banana cake',
    ...
    expect(expand('{cold,warm} banana {bread,muffin,cake}'))
        .toEqual([
            'cold banana bread',
            'cold banana muffin',
            'cold banana cake',
...
test('mix and match', () => {
    expect(expand('It was called {red,blue,yellow} [3..5]'))
        .toEqual([
            'It was called red 3',
            'It was called red 4',
            'It was called red 5',
